<html>
    ...
    <head>
        ...
        <?php
            ...
            if(isset($_POST['save']))
            {
                $sql="insert into  adminsignup(User_id,Name,Gender,Dateofbirth,Mobile,Email,Address,Passwrd) values('$_POST[uid]','$_POST[nm]','$_POST[gen]','$_POST[dob]',$_POST[mob],'$_POST[email]','$_POST[address]','$_POST[pass]')";
    ...
    <body>
        ...
        <section>
           <div class="box" style="border-style: solid; border-width: thin; border-color:black; border-width: 3px; height: 850px; width: 900px; " >
                        ...
                        <tr>
                            <td width="75%">
                                <div style="padding: 80px;" >
                                    ...
                                    <table>
                                        <tr><td ><font color="green" size="5px"><h1>Admin Registration</h1></font></td></tr>
                                        <form action="adminsignup.php" method="POST" >
                                            ...
                                            <td width="50%" align="center" ><input type="submit" value="Register" name="save" style="height:30px; width: 120px; background-color: rgb(53, 198, 34); " ></td></tr></tr>
                                        </form>
                                    </table>
                                </div>
                            </td>
                            <td class="seller" width="20%" style="background-color: rgb(244, 235, 159);" >
                                ...
                                <h3 align="center" ><a href="#">Admin</a></h3></font>
                            </td>
                        </tr>
                    </table>
                </div>
