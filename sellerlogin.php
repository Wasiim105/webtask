...
<head>
    ...
    <?php
        ...
        if(isset($_POST['log_in']))
        {
            ...
            $sql="SELECT * FROM sellersignup where User_id='$uid1' and passwrd='$pass1' ";
            ...
            if($result->num_rows>0)
            {
                ...
                echo "<script>window.location='sellerloginhome.php?val=".$snm."';</script>";
            }
            else
        {
                            ...
                            <tr>
                                <td width="75%">
                                    <div style="padding: 80px;" >
                                        <table class="admin" >
                                            <tr><td><font color="green" size="5px" ><h1 align="right" >Seller Login</h1></font></td></tr>
