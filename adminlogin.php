...
<head>
    ...
    <?php
        ...
        if(isset($_POST['log_in']))
        {
            ...
            $sql="SELECT * FROM adminsignup where User_id='$uid1' and passwrd='$pass1' ";
                            ...
                            <tr>
                                <td width="75%">
                                    <div style="padding: 80px;" >
                                        <table class="admin" >
                                            <tr><td width="55%" ><font color="green" size="5px" ><h1 align="right" >Admin Login</h1></font></td></tr>
                                            <form action="adminlogin.php" method="POST" >
                                                
                                                <tr><td><h3 align="center" > User ID</h3></td><td><input type="text" style="height:25px; width: 200px;" name="uid" id="uid" ></td></tr>
                                                <tr><td width="200px" ><h3 align="center" >Password</h3></td><td><input type="password" style="height:25px; width: 200px;" name="pass" id="pass"></td></tr>
